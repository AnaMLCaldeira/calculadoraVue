...
export default {
  ...
  methods: {
    ...
    /**Método responsável por colocar o sinal '-' ou '+' para realização
    ...
    /**Método responsável por realizar operações de porcentagem */
    porcentagem(){
    ...
    /**Método responsável por realizar a operação da multiplicação */
    multiplicar(){
      this.operador = (num1, num2) => num1 * num2;
      this.setarValor();
    },

    /**Método responsável por realizar a operação da subtração */
    subtrair(){
      this.operador = (num1, num2) => num1 - num2;
      this.setarValor();
    },

    /**Método responsável por realizar a operação da soma */
    somar(){
      this.operador = (num1, num2) => num1 + num2;
      this.setarValor();
    },
